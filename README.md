...
## Array
- [find the length of the longest substring, which has all distinct characters](./PlacementCoding/src/com/coding/day0/AllDistinctElemetSubArrayMax.java)
- [array ques2](./path)
...
- [Given a sorted integer array containing duplicates, count occurrences of a given number.](./PlacementCoding/src/com/coding/bs/FindOccurenceOfGivenNumber.java)
